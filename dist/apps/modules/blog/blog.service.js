...
const UploadImageToCloudinary_1 = __importDefault(
  require('../../utils/uploadImageToCloudinary'),
)
const blog_model_1 = require('./blog.model')
const createBlogIntoDb = (file, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (file) {
      ...
      const uploadResponse = yield (0, UploadImageToCloudinary_1.default)(
        imageName,
        path,
      )
...
const getSingleBlogsFromDb = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blog_model_1.blogModel.findById(id)
    return result
  })
const updateblogsFromDb = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
